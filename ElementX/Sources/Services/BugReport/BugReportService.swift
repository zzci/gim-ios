...
class BugReportService: NSObject, BugReportServiceProtocol {
    ...
    func submitBugReport(_ bugReport: BugReport,
        ...
        if let crashEventID = lastCrashEventID {
            params.append(MultipartFormData(key: "crash_report", type: .text(value: "crash-event-id:\(crashEventID)")))
    ...
    private var defaultParams: [MultipartFormData] {
        ...
        let version = "\(InfoPlistReader.main.bundleShortVersionString) (\(GitVersion.commitHash))"
        return [
            ...
            MultipartFormData(key: "build", type: .text(value: GitVersion.commitHash)),
